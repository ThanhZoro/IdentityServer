...
namespace IdentityServer
{
    public class LocalizationQueryProvider : RequestCultureProvider
    {
        ...
        public string QueryParameterName { get; set; } = DefaultParamterName;
        ...
        public override Task<ProviderCultureResult> DetermineProviderCultureResult(HttpContext httpContext)
        {
            ...
            {
                var newCookieValue = CookieRequestCultureProvider.MakeCookieValue(new RequestCulture("vi-VN"));
                httpContext.Response.Cookies.Append(".AspNetCore.Culture", newCookieValue);
                providerResultCulture = ParseDefaultParamterValue("vi-VN");
            }
            else
            {
